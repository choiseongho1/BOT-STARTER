...
exports.RANK_GROUP_LABELS = exports.RANK_GROUPS = void 0;
exports.tierLabelFromLevel = tierLabelFromLevel;
exports.tierClauseForGroup = tierClauseForGroup;
exports.inTierGroup = inTierGroup;
exports.RANK_GROUPS = [
    "unrated",
    "bronze",
    "silver",
...
function tierClauseForGroup(tierGroup) {
...
function inTierGroup(level, tierGroup) {
    if (tierGroup === "all") {
        return true;
    }
    if (tierGroup === "unrated") {
