...
class BojSidebarViewProvider {
    ...
    async handleSidebarMessage(rawMessage) {
    ...
    async dispatchSidebarMessage(message) {
        switch (message.type) {
            case "ready":
    ...
    async handleCreateFromRecentMessage(problemId) {
